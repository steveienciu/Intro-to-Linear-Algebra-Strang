/* program to find the sun of two matrices */
...
int main()
{
	double **matrix_sum, **matrix1, **matrix2;
	int m1, m2, n1, n2;
	...
	matrix_sum = matrix_mem_alloc(m1, n1);
	if (matrix_sum == NULL) {
		free_matrix(matrix1, m1);
	...
	matrix_addition(matrix_sum, matrix1, matrix2, m1, n1);

	// print sum of the two matrices
	printf("The sum of the two matrices is:\n");
	print_matrix(matrix_sum, m1, n1);

	// deallocate memory for the matrices
	free_matrix(matrix1, m1); free_matrix(matrix2, m2); free_matrix(matrix_sum, m1);
